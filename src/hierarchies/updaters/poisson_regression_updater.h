#ifndef SPATIALCMC_HIERARCHIES_UPDATERS_POISSON_REGRESSION_UPDATER_H_
#define SPATIALCMC_HIERARCHIES_UPDATERS_POISSON_REGRESSION_UPDATER_H_
...
class PoissonRegUpdater : public SemiConjugateUpdater<PoissonRegLikelihood, GammaPriorModel> {
 public:
  PoissonRegUpdater() = default;
  ~PoissonRegUpdater() = default;
...
#endif // SPATIALCMC_HIERARCHIES_UPDATERS_POISSON_REGRESSION_UPDATER_H_