...
#' This represents the geometry associated to each datum.
...
#'
#' @export
run_cmc <- function(data, geometry, shard_allocation, hier_type,
  ...
  params = paste("--data-file '%s' --adj-matrix-file '%s' --shard-assignment-file '%s' --algo-params-file '%s'",
