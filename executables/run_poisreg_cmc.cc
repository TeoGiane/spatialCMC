...
int main(int argc, char const *argv[]) {
  ...
  // Create hierarchy object (NON SERVE)
  ...
  // Create mixing object (NON SERVE)
  ...
  // Generating shards in parallel (SERVE POISREG_SHARD)
  // std::vector<Eigen::MatrixXd> data_in_shards(num_shards); (NON SERVE)
  // std::vector<PoissonRegShard> shards(num_shards);
